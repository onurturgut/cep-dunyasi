...
const categorySeeds = [
  ...
  { name: "Akıllı Saatler", slug: "akilli-saatler", icon: "Watch" },
  { name: "Kılıf", slug: "kilif", icon: "ShieldCheck" },
  { name: "Şarj Aleti", slug: "sarj-aleti", icon: "BatteryCharging" },
...
const baseProductSeeds: ProductSample[] = [
  ...
  {
    name: "Hızlı USB-C Şarj Aleti",
    slug: "hizli-usb-c-sarj-aleti",
    description: "65W hızlı şarj adaptörü",
  ...
  {
    name: "Spigen Kılıf AirFit",
    slug: "spigen-kilif-airfit",
    description: "iPhone 15 ile uyumlu ince ve darbe emici kılıf",
    categorySlug: "kilif",
    brand: "Spigen",
    type: "accessory",
  ...
  },
  {
    ...
    description: "AMOLED ekranlı akıllı saat ve uzun pil ömrü",
  ...
  },
  {
    ...
    description: "Hızlı şarj destekli yüksek kapasiteli power bank",
  ...
  },
  {
    ...
    description: "2. el kalite kontrolünden geçmiş iPhone 13",
  ...
  {
    name: "Ekran Değişim Servisi",
    slug: "ekran-degisim-servisi",
    description: "Profesyonel ekip ile hızlı ekran değişim hizmeti",
    ...
    variant: {
      ...
      attributes: { sure: "Aynı Gün", garanti: "6 Ay" },
      price: 1999,
      stock: 999,
    },
  },
...
const generatedProductTemplates: GeneratedProductTemplate[] = [
  {
    ...
    skuPrefix: "IPH15PLS",
    description: "Büyük ekranlı ve uzun pil ömürlü iPhone modeli.",
    categorySlug: "telefon",
    brand: "Apple",
    type: "phone",
  ...
  },
  {
    ...
    skuPrefix: "REF-PH",
    description: "Kalite kontrol testlerinden geçmiş, garantili yenilenmiş telefon.",
    categorySlug: "ikinci-el-telefon",
    brand: "RenewTech",
    type: "phone",
  ...
  },
  {
    ...
    skuPrefix: "PULSE-W",
    description: "Sağlık takibi ve bildirim özellikleriyle akıllı saat.",
    categorySlug: "akilli-saatler",
    brand: "Pulse",
    type: "accessory",
  ...
  {
    namePrefix: "Armor Kılıf",
    slugPrefix: "armor-kilif",
    skuPrefix: "ARMOR-K",
    description: "Günlük kullanım için ince, darbeye dayanıklı koruyucu kılıf.",
    categorySlug: "kilif",
    brand: "Armor",
    type: "accessory",
    image: "https://images.unsplash.com/photo-1601593346740-925612772716?w=1200&q=80",
  ...
  {
    namePrefix: "Turbo Şarj Aleti",
    slugPrefix: "turbo-sarj",
    skuPrefix: "TURBO-C",
    description: "PD destekli hızlı şarj adaptörü ve güvenli enerji yönetimi.",
    categorySlug: "sarj-aleti",
    brand: "Turbo",
    type: "accessory",
  ...
  },
  {
    ...
    skuPrefix: "MAX-PB",
    description: "Yüksek kapasiteli, hızlı şarj çıkışlı taşınabilir batarya.",
    categorySlug: "power-bank",
    brand: "MaxCharge",
    type: "accessory",
    image: "https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=1200&q=80",
  ...
  },
  {
    ...
    skuPrefix: "SRV-EKR",
    description: "Profesyonel ekip ile ekran onarım ve test hizmeti.",
    categorySlug: "teknik-servis",
    brand: "Cep Dünyası",
    type: "service",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&q=80",
  ...
  },
  {
    ...
    skuPrefix: "SRV-BAT",
    description: "Batarya değişimi, kalibrasyon ve performans testi hizmeti.",
    categorySlug: "teknik-servis",
    brand: "Cep Dünyası",
    type: "service",
  ...
  {
    namePrefix: "Servis Yazılım Paketi",
    slugPrefix: "servis-yazilim-paketi",
    skuPrefix: "SRV-YAZ",
    description: "Yazılım optimizasyonu, güncelleme ve güvenlik kontrolü hizmeti.",
    categorySlug: "teknik-servis",
    brand: "Cep Dünyası",
    type: "service",
...
const serviceDurations = ["Aynı Gün", "24 Saat", "48 Saat"];
...
function buildFakeSaleTemplates(variants: SeedVariantRecord[], productNameById: Map<string, string>) {
  ...
  return Array.from({ length: TOTAL_FAKE_SALES_COUNT }, (_, index): FakeSaleTemplate => {
    ...
    const items = itemBlueprints.map((entry) => ({
      ...
      product_name: productNameById.get(entry.variant.product_id) ?? "Ürün",
...
const missionItemSeeds = [
  {
    ...
    description: "Arıza tespit ve onarım sürecinde anlık bilgilendirme.",
    media_type: "video",
    media_url: "https://www.w3schools.com/html/mov_bbb.mp4",
    media_poster: "https://images.pexels.com/photos/257736/pexels-photo-257736.jpeg",
    list_items: ["Ekran Değişimi", "Batarya", "Şarj Soketi", "Yazılım Güncelleme", "Test Raporu"],
    sort_order: 2,
    is_active: true,
  },
  {
    ...
    description: "Siparişin hazırlıktan teslimata kadar takip edilebilir.",
    media_type: "image",
    media_url: "https://images.pexels.com/photos/4246120/pexels-photo-4246120.jpeg",
    media_poster: "",
    list_items: ["Aynı Gün Kargo", "Sigortalı Paket", "Canlı Takip", "Kolay İade", "Müşteri Bildirimi"],
    sort_order: 3,
    is_active: true,
  },
];

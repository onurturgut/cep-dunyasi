  ...
  return (
    <section className="space-y-4" id="specs">
      <div className="space-y-2">
        <h2 className="font-display text-2xl font-semibold tracking-tight text-foreground">Teknik Ozellikler</h2>
        <p className="max-w-2xl text-sm leading-6 text-muted-foreground">
          Secili varyanta ve urun kaydina ait teknik bilgiler, sade ve okunabilir bir formatta sunulur.
        </p>
      </div>

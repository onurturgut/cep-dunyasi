...
export function ExploreCategoriesSection({ categories, content }: ExploreCategoriesSectionProps) {
  ...
  return (
    <section id="home-explore" data-section="explore" className="relative py-4 md:py-6">
      ...
      <div className="container">
        <div className="space-y-4">
          <h2 className="font-display text-2xl font-bold sm:text-3xl md:text-4xl">{content.explore_section_title || "Kategoriler"}</h2>
